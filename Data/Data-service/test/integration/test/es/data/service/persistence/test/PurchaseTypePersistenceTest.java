...
import test.es.data.exception.NoSuchPurchaseTypeException;
...
import test.es.data.service.persistence.PurchaseTypeUtil;
...
public class PurchaseTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPurchaseType.setUserId(RandomTestUtil.nextLong());

		newPurchaseType.setUserName(RandomTestUtil.randomString());

		newPurchaseType.setCreateDate(RandomTestUtil.nextDate());

		newPurchaseType.setModifiedDate(RandomTestUtil.nextDate());

		newPurchaseType.setPurchaseTypeName(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingPurchaseType.getUserId(), newPurchaseType.getUserId());
		Assert.assertEquals(
			existingPurchaseType.getUserName(), newPurchaseType.getUserName());
		Assert.assertEquals(
			Time.getShortTimestamp(existingPurchaseType.getCreateDate()),
			Time.getShortTimestamp(newPurchaseType.getCreateDate()));
		Assert.assertEquals(
			Time.getShortTimestamp(existingPurchaseType.getModifiedDate()),
			Time.getShortTimestamp(newPurchaseType.getModifiedDate()));
		Assert.assertEquals(
			existingPurchaseType.getPurchaseTypeName(),
			newPurchaseType.getPurchaseTypeName());
	}
	...
	protected OrderByComparator<PurchaseType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"ES_PurchaseType", "mvccVersion", true, "uuid", true,
			"purchaseTypeId", true, "groupId", true, "companyId", true,
			"userId", true, "userName", true, "createDate", true,
			"modifiedDate", true, "purchaseTypeName", true);
	}
	...
	protected PurchaseType addPurchaseType() throws Exception {
		...
		purchaseType.setUserId(RandomTestUtil.nextLong());

		purchaseType.setUserName(RandomTestUtil.randomString());

		purchaseType.setCreateDate(RandomTestUtil.nextDate());

		purchaseType.setModifiedDate(RandomTestUtil.nextDate());

		purchaseType.setPurchaseTypeName(RandomTestUtil.randomString());
