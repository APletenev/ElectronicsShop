...
public class ElectroTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newElectroType.setGroupId(RandomTestUtil.nextLong());

		newElectroType.setCompanyId(RandomTestUtil.nextLong());

		newElectroType.setUserId(RandomTestUtil.nextLong());

		newElectroType.setUserName(RandomTestUtil.randomString());

		newElectroType.setCreateDate(RandomTestUtil.nextDate());

		newElectroType.setModifiedDate(RandomTestUtil.nextDate());

		newElectroType.setElectroTypeName(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingElectroType.getGroupId(), newElectroType.getGroupId());
		Assert.assertEquals(
			existingElectroType.getCompanyId(), newElectroType.getCompanyId());
		Assert.assertEquals(
			existingElectroType.getUserId(), newElectroType.getUserId());
		Assert.assertEquals(
			existingElectroType.getUserName(), newElectroType.getUserName());
		Assert.assertEquals(
			Time.getShortTimestamp(existingElectroType.getCreateDate()),
			Time.getShortTimestamp(newElectroType.getCreateDate()));
		Assert.assertEquals(
			Time.getShortTimestamp(existingElectroType.getModifiedDate()),
			Time.getShortTimestamp(newElectroType.getModifiedDate()));
		Assert.assertEquals(
			existingElectroType.getElectroTypeName(),
			newElectroType.getElectroTypeName());
	}
	...
	protected OrderByComparator<ElectroType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"ES_ElectroType", "mvccVersion", true, "uuid", true,
			"electroTypeId", true, "groupId", true, "companyId", true, "userId",
			true, "userName", true, "createDate", true, "modifiedDate", true,
			"electroTypeName", true);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		_assertOriginalValues(
			_persistence.findByPrimaryKey(newElectroType.getPrimaryKey()));
	}
	...
	private void _assertOriginalValues(ElectroType electroType) {
		Assert.assertEquals(
			electroType.getUuid(),
			ReflectionTestUtil.invoke(
				electroType, "getColumnOriginalValue",
				new Class<?>[] {String.class}, "uuid_"));
		Assert.assertEquals(
			Long.valueOf(electroType.getGroupId()),
	...
	protected ElectroType addElectroType() throws Exception {
		...
		electroType.setGroupId(RandomTestUtil.nextLong());

		electroType.setCompanyId(RandomTestUtil.nextLong());

		electroType.setUserId(RandomTestUtil.nextLong());

		electroType.setUserName(RandomTestUtil.randomString());

		electroType.setCreateDate(RandomTestUtil.nextDate());

		electroType.setModifiedDate(RandomTestUtil.nextDate());

		electroType.setElectroTypeName(RandomTestUtil.randomString());
