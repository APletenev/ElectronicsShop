...
create index IX_BCA6F880 on ES_Electronics (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_CC939F02 on ES_Electronics (uuid_[$COLUMN_LENGTH:75$], groupId);
