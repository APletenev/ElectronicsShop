...
public class ElectronicsPersistenceImpl
	...
	/**
	 * Returns the electronics where uuid = &#63; and groupId = &#63; or throws a <code>NoSuchElectronicsException</code> if it could not be found.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public Electronics findByUUID_G(String uuid, long groupId)
		throws NoSuchElectronicsException {

		Electronics electronics = fetchByUUID_G(uuid, groupId);
	...
	/**
	 * Returns the electronics where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public Electronics fetchByUUID_G(String uuid, long groupId) {
		return fetchByUUID_G(uuid, groupId, true);
	}

	/**
	 * Returns the electronics where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @param useFinderCache whether to use the finder cache
	 ...
	 */
	@Override
	public Electronics fetchByUUID_G(
		...
		if (result instanceof Electronics) {
			...
			if (!Objects.equals(uuid, electronics.getUuid()) ||
				(groupId != electronics.getGroupId())) {
	...
	/**
	 * Removes the electronics where uuid = &#63; and groupId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public Electronics removeByUUID_G(String uuid, long groupId)
		throws NoSuchElectronicsException {

		Electronics electronics = findByUUID_G(uuid, groupId);

		return remove(electronics);
	}

	/**
	 * Returns the number of electronicses where uuid = &#63; and groupId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the number of matching electronicses
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"electronics.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(electronics.uuid IS NULL OR electronics.uuid = '') AND ";
	...
	/**
	 * Returns all the electronicses where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<Electronics> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
			uuid, companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the electronicses where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ElectronicsModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Electronics> findByUuid_C(
	...
	/**
	 * Returns an ordered range of all the electronicses where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ElectronicsModelImpl</code>.
	 * </p>
	...
	public List<Electronics> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Electronics electronics : list) {
					if (!uuid.equals(electronics.getUuid()) ||
						(companyId != electronics.getCompanyId())) {
	...
	/**
	 * Returns the first electronics in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Electronics findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<Electronics> orderByComparator)
		throws NoSuchElectronicsException {

		Electronics electronics = fetchByUuid_C_First(
	 ...
	 */
	@Override
	public Electronics fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Electronics> orderByComparator) {

		List<Electronics> list = findByUuid_C(
	...
	/**
	 * Returns the last electronics in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Electronics findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Electronics> orderByComparator)
		throws NoSuchElectronicsException {

		Electronics electronics = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	 ...
	 */
	@Override
	public Electronics fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Electronics> orderByComparator) {
	...
	/**
	 * Returns the electronicses before and after the current electronics in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param electronicsId the primary key of the current electronics
	 * @param uuid the uuid
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Electronics[] findByUuid_C_PrevAndNext(
			long electronicsId, String uuid, long companyId,
			OrderByComparator<Electronics> orderByComparator)
		throws NoSuchElectronicsException {
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, electronics, uuid, companyId, orderByComparator, true);

			array[1] = electronics;

			array[2] = getByUuid_C_PrevAndNext(
				session, electronics, uuid, companyId, orderByComparator,
				false);
	...
	protected Electronics getByUuid_C_PrevAndNext(
		Session session, Electronics electronics, String uuid, long companyId,
		OrderByComparator<Electronics> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the electronicses where uuid = &#63; and companyId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 */
	...
	/**
	 * Returns the number of electronicses where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the number of matching electronicses
	...
	public void cacheResult(Electronics electronics) {
		...
		finderCache.putResult(
			...
			new Object[] {electronics.getUuid(), electronics.getGroupId()},
			electronics);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			electronicsModelImpl.getUuid(), electronicsModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, electronicsModelImpl, false);
	}
