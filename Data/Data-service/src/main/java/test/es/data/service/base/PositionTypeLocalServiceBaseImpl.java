 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link test.es.data.service.impl.PositionTypeLocalServiceImpl}.
 * </p>
 *
 * @author Andrey Pletenev
 * @see test.es.data.service.impl.PositionTypeLocalServiceImpl
 * @generated
 */
public abstract class PositionTypeLocalServiceBaseImpl
	...
	public PositionType fetchPositionTypeByUuidAndGroupId(
		...
		return positionTypePersistence.fetchByUUID_G(uuid, groupId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod<PositionType>() {
				...
				public void performAction(PositionType positionType)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, positionType);
				}
	...
	public List<PositionType> getPositionTypesByUuidAndCompanyId(
		...
		return positionTypePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PositionType> getPositionTypesByUuidAndCompanyId(
		...
		return positionTypePersistence.findByUuid_C(
	...
	public PositionType getPositionTypeByUuidAndGroupId(
		...
		return positionTypePersistence.findByUUID_G(uuid, groupId);
	}
