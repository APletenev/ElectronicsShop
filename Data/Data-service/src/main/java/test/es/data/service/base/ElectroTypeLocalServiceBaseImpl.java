 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link test.es.data.service.impl.ElectroTypeLocalServiceImpl}.
 * </p>
 *
 * @author Andrey Pletenev
 * @see test.es.data.service.impl.ElectroTypeLocalServiceImpl
 * @generated
 */
public abstract class ElectroTypeLocalServiceBaseImpl
	...
	public ElectroType fetchElectroTypeByUuidAndGroupId(
		...
		return electroTypePersistence.fetchByUUID_G(uuid, groupId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod<ElectroType>() {
				...
				public void performAction(ElectroType electroType)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, electroType);
				}
	...
	public List<ElectroType> getElectroTypesByUuidAndCompanyId(
		...
		return electroTypePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ElectroType> getElectroTypesByUuidAndCompanyId(
		...
		return electroTypePersistence.findByUuid_C(
	...
	public ElectroType getElectroTypeByUuidAndGroupId(String uuid, long groupId)
		...
		return electroTypePersistence.findByUUID_G(uuid, groupId);
	}
