...
import test.es.data.model.impl.PurchaseTypeImpl;
import test.es.data.model.impl.PurchaseTypeModelImpl;
...
public class PurchaseTypePersistenceImpl
	...
	public PurchaseType updateImpl(PurchaseType purchaseType) {
		...
		if (isNew && (purchaseType.getCreateDate() == null)) {
			if (serviceContext == null) {
				purchaseType.setCreateDate(date);
			}
			else {
				purchaseType.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!purchaseTypeModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				purchaseType.setModifiedDate(date);
			}
			else {
				purchaseType.setModifiedDate(
	...
	private static class PurchaseTypeModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= PurchaseTypeModelImpl.getColumnBitmask(
				"purchaseTypeName");
