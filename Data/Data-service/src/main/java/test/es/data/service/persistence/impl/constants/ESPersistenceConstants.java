...
package test.es.data.service.persistence.impl.constants;
...
public class ESPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "test.es.data.service";
