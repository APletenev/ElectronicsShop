...
public interface ElectronicsPersistence extends BasePersistence<Electronics> {
	 ...
	 * @return the matching electronicses
	 */
	public java.util.List<Electronics> findByUuid_C(
	 ...
	 * @return the matching electronicses
	 */
	public java.util.List<Electronics> findByGroupId(long groupId);
	 ...
	 * @return the range of matching electronicses
	 */
	public java.util.List<Electronics> findByGroupId(
