...
public interface PositionTypePersistence extends BasePersistence<PositionType> {
	 ...
	 * @return the matching position types
	 */
	public java.util.List<PositionType> findByUuid_C(
	 ...
	 * @return the matching position types
	 */
	public java.util.List<PositionType> findByGroupId(long groupId);
	 ...
	 * @return the range of matching position types
	 */
	public java.util.List<PositionType> findByGroupId(
