...
public class ElectroTypeUtil {
	...
	public static ElectroType findByUuid_First(
		...
		throws test.es.data.exception.NoSuchElectroTypeException {
	 ...
	 * @throws NoSuchElectroTypeException if a matching electro type could not be found
	 */
	public static ElectroType findByUUID_G(String uuid, long groupId)
		throws test.es.data.exception.NoSuchElectroTypeException {
	 ...
	 */
	public static ElectroType fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching electro type, or <code>null</code> if a matching electro type could not be found
	 */
	public static ElectroType fetchByUUID_G(
	 ...
	 */
	public static ElectroType removeByUUID_G(String uuid, long groupId)
		throws test.es.data.exception.NoSuchElectroTypeException {
	 ...
	 * @return the matching electro types
	 */
	public static List<ElectroType> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching electro types
	 */
	public static List<ElectroType> findByGroupId(
	 ...
	 * @throws NoSuchElectroTypeException if a matching electro type could not be found
	 */
	public static ElectroType findByGroupId_First(
	 ...
	 * @return the first matching electro type, or <code>null</code> if a matching electro type could not be found
	 */
	public static ElectroType fetchByGroupId_First(
		long groupId, OrderByComparator<ElectroType> orderByComparator) {
	 ...
	 * @throws NoSuchElectroTypeException if a matching electro type could not be found
	 */
	public static ElectroType findByGroupId_Last(
			long groupId, OrderByComparator<ElectroType> orderByComparator)
		throws test.es.data.exception.NoSuchElectroTypeException {
	 ...
	 * @return the last matching electro type, or <code>null</code> if a matching electro type could not be found
	 */
	public static ElectroType fetchByGroupId_Last(
		long groupId, OrderByComparator<ElectroType> orderByComparator) {
	 ...
	 * @throws NoSuchElectroTypeException if a electro type with the primary key could not be found
	 */
	public static ElectroType[] findByGroupId_PrevAndNext(
			long electroTypeId, long groupId,
			OrderByComparator<ElectroType> orderByComparator)
		throws test.es.data.exception.NoSuchElectroTypeException {

		return getPersistence().findByGroupId_PrevAndNext(
			electroTypeId, groupId, orderByComparator);
	}
