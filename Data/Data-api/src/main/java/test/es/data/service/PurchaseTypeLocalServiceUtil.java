 ...
 * <code>test.es.data.service.impl.PurchaseTypeLocalServiceImpl</code> and
...
public class PurchaseTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>test.es.data.service.impl.PurchaseTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static PurchaseType addPurchaseType(
		...
		return getService().addPurchaseType(
	...
	public static int getPurchaseTypeCount(long groupId) {
		return getService().getPurchaseTypeCount(groupId);
	}
