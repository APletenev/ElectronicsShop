...
public interface ElectroTypeLocalService
	...
	public ElectroType addElectroType(
			long userId, String electroTypeName, ServiceContext serviceContext)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroType fetchElectroTypeByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroType getElectroTypeByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ElectroType> getElectroTypesByUuidAndCompanyId(
	...
	public ElectroType updateElectroType(
