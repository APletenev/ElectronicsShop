...
public class ElectroTypePortlet extends MVCPortlet {
	...
	public void addEntry(ActionRequest request, ActionResponse response) throws PortalException {
        ...
        ServiceContext serviceContext = ServiceContextFactory.getInstance(
            ...
            if (entryId > 0) {
    			try {
    				_electroTypeLocalService.updateElectroType (serviceContext.getUserId(), entryId, electroTypeName, serviceContext);
	...
	public void deleteEntry(ActionRequest request, ActionResponse response) throws PortalException {
        ...
        try {
            ...
            Logger.getLogger(ElectroTypePortlet.class.getName()).log(
                Level.SEVERE, null, e);
        }
}
